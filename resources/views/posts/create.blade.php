                ...
                <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="p-4">
                        <div class="flex flex-col">
                            <label for="title" class="text-gray-700">{{ __('Title') }}</label>
                    ...
                    <div class="p-4">
                        <div class="flex flex-col">
                            <label for="post_text" class="text-gray-700">{{ __('Text') }}</label>
                    ...
                    <div class="p-4">
                        <div class="flex flex-col">
                            <label for="images" class="text-gray-700">{{ __('Images') }}</label>
